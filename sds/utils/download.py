# Copy-pasted from https://github.com/mosaicml/streaming/blob/main/streaming/base/storage/download.py.
...
from sds.structs import DEFAULT_TIMEOUT
...
#---------------------------------------------------------------------------
# List of custom cloud downloaders.
...
def get_import_exception_message(package_name: str, extra_deps: str) -> str:
    ...
    """
    return f'Streaming Dataset was installed without {package_name} support. ' + \
